...
export default function SettingsPage() {
    ...
    if (childrenData?.data) {
      childrenData.data.forEach(async (child: any) => {
        try {
          ...
          console.error(`Failed to load data for child ${child.id}:`, error);
        }
      });
    }
  }, [childrenData]);
  ...
  return (
    <div className="-mx-6 px-6 max-w-6xl mx-auto pb-24">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          >
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="text-lg font-semibold text-gray-900">孩子信息</h2>
            </div>
                ...
                {isLoadingChildren ? (
                  ...
                  <div className="space-y-4">
                    {childrenData.data.map((child: any) => {
                      ...
                      return (
                        <div key={child.id} className="border-b border-gray-100 pb-4 last:border-0 last:pb-0">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                <p className="text-xs text-gray-500 mt-0.5">ID: {child.id}</p>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="grid grid-cols-3 gap-3 mb-3">
                            <div className="bg-purple-50 rounded-xl p-3 text-center">
                              ...
                              <p className="text-lg font-semibold text-purple-600">{stats.weeklyStudyTime || 0}分钟</p>
                            </div>
                            <div className="bg-green-50 rounded-xl p-3 text-center">
                              <p className="text-xs text-gray-500">完成任务</p>
                              <p className="text-lg font-semibold text-green-600">{stats.completedTasks || 0}</p>
                            </div>
                            <div className="bg-blue-50 rounded-xl p-3 text-center">
                              <p className="text-xs text-gray-500">成就</p>
                              <p className="text-lg font-semibold text-blue-600">{stats.achievements || 0}</p>
                            </div>
                          </div>
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between">
                              <p className="text-sm font-medium text-gray-700">本周进度</p>
                              <p className="text-sm font-semibold text-purple-600">{stats.weeklyProgress || 0}%</p>
                            </div>
      ...
      <AlertDialog open={addChildOpen} onOpenChange={setAddChildOpen}>
        <AlertDialogContent className="rounded-2xl">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-green-600">添加孩子</AlertDialogTitle>
            <AlertDialogDescription>
              为您的家庭添加一个新的孩子账户
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="child-avatar">头像表情</Label>
              <Input 
                id="child-avatar" 
                value={childAvatar}
                onChange={(e) => setChildAvatar(e.target.value)}
                placeholder="输入一个表情，如 🐶"
                className="h-11 rounded-xl"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="child-password">密码</Label>
              <Input 
                id="child-password" 
                type="password"
                value={childPassword}
                onChange={(e) => setChildPassword(e.target.value)}
                placeholder="设置孩子的登录密码"
                className="h-11 rounded-xl"
              />
            </div>
            <div className="space-y-2">
              <Label htmlFor="confirm-child-password">确认密码</Label>
              <Input 
      ...
      <AlertDialog open={editChildOpen} onOpenChange={setEditChildOpen}>
        <AlertDialogContent className="rounded-2xl">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-blue-600">编辑孩子信息</AlertDialogTitle>
            <AlertDialogDescription>
              修改孩子的基本信息、头像和兴趣爱好
            </AlertDialogDescription>
          </AlertDialogHeader>
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="space-y-2">
                  <div className="space-y-2">
                    <Label htmlFor="edit-child-avatar">头像表情</Label>
                    <Input 
                      id="edit-child-avatar" 
                      value={childAvatar}
                      onChange={(e) => setChildAvatar(e.target.value)}
                      placeholder="输入一个表情，如 🐶"
                      className="h-11 rounded-xl"
            ...
            {/* Basic Info */}
            <div className="space-y-2">
              <Label htmlFor="edit-child-name">孩子姓名</Label>
              <Input 
                id="edit-child-name" 
                value={childName}
                onChange={(e) => setChildName(e.target.value)}
            ...
            {/* Interests */}
            <div className="space-y-2">
              <Label htmlFor="child-interests">兴趣爱好</Label>
              <Input 
                id="child-interests" 
                placeholder="例如：阅读、绘画、音乐"
                className="h-11 rounded-xl"
              />
            </div>
            ...
            {/* Grade */}
            <div className="space-y-2">
              <Label htmlFor="child-grade">年级</Label>
              <Input 
                id="child-grade" 
                placeholder="例如：一年级"
                className="h-11 rounded-xl"
