...
- 当前分支：`main`
- 当前阶段：`1.9.0` 首轮功能收口
- 工作区状态：1.9 三层准备度模型、目标引擎、轻量诊断、稳定性层入口和数理认知试点字段已完成首轮落地与本地功能验收
- 文档索引：`docs/README.md`
...
- 1.9 设计方案已整理到 `docs/design-1.9-ability-goal-engine.md`，明确三层准备度模型、诊断引擎、1.9 范围和后续分步路线。
...
1. 启动本地前端，走查 1.9 核心页面和弹窗。
2. 修正页面视觉、交互和字段文案问题。
3. 补 1.9 回归记录。
4. 再评估是否进入后端数据模型和配置层迁移。
