...
- `current-progress.md`：当前进度和最近完成事项。
...
- `child-profile.md`：当前家庭和孩子背景资料。
- `legacy-system-design.md`：早期系统设计说明。
...
- `reports/`：历史审查、分析和修复报告。
- `operations/`：历史部署命令、生产恢复和运维收口记录。
- `product/`：旧产品手册。
- `guidelines/`：旧 UI 或撰写规范。
